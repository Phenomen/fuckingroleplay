...
$(function() {
    ...
    WTF.init({
        ...
        template: [
            "<dt>@humanfirstname @humanlastname</dt> @adjective Человек @dclass из @location, который @backstory",
            "<dt>@dwarffirstname @dwarflastname</dt> @adjective Дварф @dclass из @location, который @backstory",
            "<dt>@elffirstname @elflastname</dt> @adjective Эльф @dclass из @location, который @backstory",
            "<dt>@elffirstname @elflastname</dt> @adjective Полу-эльф @dclass из @location, который @backstory",
            "<dt>@humanfirstname @humanlastname</dt> @adjective Полу-эльф @dclass из @location, который @backstory",
            "<dt>@gnomefirstname @gnomelastname</dt> @adjective Гном @dclass из @location, который @backstory",
            "<dt>@halforcfirstname @halforclastname</dt> @adjective Полу-орк @dclass из @location, который @backstory",
            "<dt>@halflingfirstname @halflinglastname</dt> @adjective Полурослик @dclass из @location, который @backstory",
            "<dt>@dragonbornfirstname @dragonbornlastname</dt> @adjective Драконорожденный @dclass из @location, который @backstory",
            "<dt>@tieflingfirstname @tieflinglastname</dt> @adjective Тифлинг @dclass из @location, который @backstory",
        ],
